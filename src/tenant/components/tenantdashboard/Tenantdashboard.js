    ...
    return (
            ...
            <div className="left-container">
                <div className='left-items'>
                    ...
                    <div className="menu">
                        ...
                        <div className='dashboardicon'><PaymentsSharpIcon/> <a href="#transactions">Payments</a></div>
                        <div className='dashboardicon'><SaveAsSharpIcon/> <a href="#complains">Complains</a></div>
                        <div className='dashboardicon'><LogoutRoundedIcon/> Logout</div>
                    </div>
            ...
            <div className="right-container">
                <div className='right-items' id='profile'>
                    <p className='TenantName'><i>Andrew Tate</i></p>
                    <h3 className='houseType'><i>Family House</i></h3>
                    <br />
                    <hr />
                    <div className='kyc1'>
                        <div>
                    ...
                    <div className="buttons">
                        <div className='paymentHistory'>
                            <a href="#transactions"><button>Payment history</button></a>
                        </div>
                        <div className='makepayment'>
                            <a href="#payments"><button>Make Payment</button></a>
                        </div>
                    </div>
                    <hr />
                    <hr />
                ...
                <div className="transactions" id='transactions'>
                    <div><h3>Amount Paid</h3></div>
                    <div><h3>Date Paid</h3></div>
                </div>
                <div className='kyc1'>
                        <div>
                            Ksh 25,000
                    ...
                    <i>please enter the phone number and the amount to be deducted from your Mpesa</i>
                    ...
                    <div className="sendMessage"><button>Make Payment</button></div>
                    <br />
                    <br />
                    <br />
            </div>
